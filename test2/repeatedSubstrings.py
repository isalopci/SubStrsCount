...
# Python class that identifies the substrings of 4 characters that appear 
...
class repeatedSubstrings:
    ...
    def generateSubStrings(self, originalStr: str) -> list:
    ...
    def countSubStrs(self, originalStr: str) -> list[dict]:
        ...
        listSubStr = self.generateSubStrings(originalStr)
...
if __name__ == '__main__':
    ...
    subStrDict = repeatedSubstrings().countSubStrs(originalStr)
    print(subStrDict) 
